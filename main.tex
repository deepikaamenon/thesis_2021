...
%ubcomment thisaddbibresource{refs.bib} % The filename of the bibliography
%uncomment this  \usepackage{natbib}
...
%uncomment this\bibliographystyle{plainnat}
%uncomment this\bibliography{library}
