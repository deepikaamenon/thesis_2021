...
%chapterinoneline,% Have the chapter title next to the number in one single linenfrench
ngerman,
...
\begin{abstract}
	\addchaptertocentry{Résumé} % Add the abstract to the table of contents
