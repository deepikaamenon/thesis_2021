...
\subsection{Buffers and plasmids}
...
\begin{figure}[H]
	...
	%	\includepdf[pages={1}, scale =0.8]{figures/methods/plasmid.pdf}
	\includegraphics[scale=0.9]{figures/methods/B_P1}
	%	\caption{Buffers}
\end{figure}
...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{-1.5cm}%
	\includegraphics[width=23cm,height=26cm, keepaspectratio]{figures/methods/microscope2}
%	\caption[Microscopes]
\end{figure}
