...
\subsection{Media}
All media were autoclaved and kindly provided by media kitchens at EMBL and UNIGE, and by Anne-Sophie Riviera.
\usepackage{float}
\begin{table}[hbt]
\hspace*{-2cm}%
\includegraphics[width=32cm,height=32cm,keepaspectratio, valign=t]{figures/methods/yeast_media}
\caption[Media]
\end{table}
...
\begin{figure}[H]
	\hspace*{-2cm}%
	\includegraphics[width=30cm,height=30cm,keepaspectratio, valign=t]{figures/methods/buffers}
	\caption[Buffers]
\end{figure}
