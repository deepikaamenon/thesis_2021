...
\begin{table}[H]
	...
	\vspace*{-1cm}
	\hspace*{1cm}%
	\includegraphics[width=16cm,height=16cm, keepaspectratio]{figures/methods/Buffers}
%	\caption{Buffers}
\end{table}
...
\begin{table}[H]
	...
	\vspace*{-1cm}
	\hspace*{0.5cm}%
	\includegraphics[width=22cm,height=22cm, keepaspectratio]{figures/methods/microscope}
%	\caption[Microscopes]
\end{table}
