...
\subsection{Media}
Media was kindly prepared by media kitchens of EMBL, University of Geneva, and by Anne-Sophie Riviera. For plates, 2\% w/v bacto agar was added to media. All media was autoclaved. Amino acid stocks were filter sterilised and added to the autoclaved media.
\begin{figure}[H]
\includegraphics[width=30cm,height=30cm,keepaspectratio, valign=t]{figures/results_final/yeast_media}
\end{figure}
