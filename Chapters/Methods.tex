...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{-1cm}%
%	\includegraphics[width=21cm,height=21cm, keepaspectratio]{figures/methods/Buffers}
\includepdf[pages={1}, scale=0.8]{figures/methods/Buffers}
	%	\caption{Buffers}
\end{figure}
...
%	\vspace*{-cm}
	\hspace*{1cm}%
%	\includegraphics[width=21cm,height=21cm, keepaspectratio]{figures/methods/yeast_media1}
