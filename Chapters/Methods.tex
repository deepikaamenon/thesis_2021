...
Yeast strains used in this work are presented in the table below.
\begin{table}[H]
\includegraphics[width=25cm,height=25cm,keepaspectratio]{figures/results_final/strains_@1}
\end{table}

\begin{table}[H]
	\includegraphics{figures/results_final/strains_@2}
\end{table}

\begin{figure}[H]
	\includegraphics{figures/results_final/strains_@3}
\end{figure}

\begin{figure}[H]
	\includegraphics{figures/results_final/strains_@4}
\end{figure}
