...
\subsection{Media}
Media was kindly prepared by the EMBL and University of Geneva media kitchens. Plates of all media were made by adding 2\% w/v bacto agar. All media was autoclaved. Amino acid stocks were filter sterilised and added to the autoclaved media.
\begin{table}[H]
	\centering
	\vspace*{-1cm}
	\hspace*{-1.5cm}%
