...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{1cm}%
	\includegraphics[width=19cm,height=19cm, keepaspectratio]{figures/methods/plasmid}
	%	\caption{Buffers}
\end{figure}
...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{1cm}%
	\includegraphics[width=19cm,height=19cm, keepaspectratio]{figures/methods/Buffers}
	%	\caption{Buffers}
\end{figure}


\subsection{Media}
Media was kindly prepared by the EMBL and University of Geneva media kitchens, and by Anne-Sophie Riviera. Plates containing media were made by adding 2\% w/v bacto agar. 
\begin{figure}[H]
	\centering
	\vspace*{-1cm}
	\hspace*{1cm}%
	\includegraphics[width=22cm,height=22cm, keepaspectratio]{figures/methods/yeast_media}
%	\caption[Yeast media]
\end{figure}
...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{-1cm}%
	\includegraphics[width=23cm,height=23cm, keepaspectratio]{figures/methods/microscope}
%	\caption[Microscopes]
\end{figure}
...
The ratio of spot intensity for WT to BAR strain is 1.22, so the WT spots are 1.2x brighter than the BAR spots measured in this way. Cytoplasmic background of BAR is comparable to that of the WT: the ratio obtained in this way is 0.94.
