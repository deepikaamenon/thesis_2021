...
\begin{figure}[H]
	...
	\vspace*{-2cm}
	\hspace*{1cm}%
	\includegraphics[width=19cm,height=22cm, keepaspectratio]{figures/methods/plasmid}
	%	\caption{Buffers}
\end{figure}
...
\begin{figure}[H]
	...
	\vspace*{-1cm}
	\hspace*{1cm}%
	\includegraphics[width=23cm,height=23cm, keepaspectratio]{figures/methods/yeast_media}
%	\caption[Yeast media]
\end{figure}
