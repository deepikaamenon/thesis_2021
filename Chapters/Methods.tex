...
\subsection{Buffers and Plasmids used for endogenous gene manipulation}
...
%	\includepdf[pages={1}, scale =0.8]{figures/methods/plasmid.pdf}
	\includegraphics[width=20cm,height=18cm, keepaspectratio]{figures/methods/b_p}
	%	\caption{Buffers}
\end{figure}
...
%	\centering
	%#	\vspace*{1cm}
	%	\hspace*{2cm}%
	\includegraphics[scale=0.9, keepaspectratio]{figures/methods/buffer_crop}
