...
\begin{figure}[H]
	...
	\vspace*{2cm}
	\hspace*{0.5cm}%
	\includegraphics[width=20cm,height=24cm, keepaspectratio]{figures/methods/plasmid}
	%	\caption{Buffers}
\end{figure}
...
%	\vspace*{-cm}
	\hspace*{1cm}%
	\includegraphics[width=22cm,height=23cm, keepaspectratio]{figures/methods/yeast_media}
%	\caption[Yeast media]
\end{figure}
