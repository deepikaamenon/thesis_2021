...
\subsection{Media}
Media was kindly prepared by media kitchens of EMBL and University of Geneva Biochemistry Department, and by Anne-Sophie Riviera. Plates of all media were made by adding 2\% w/v bacto agar.
All media was autoclaved. Amino acid stocks were filter sterilised and added to the autoclaved media.
\begin{figure}[H]
		\hspace*{-1.5cm}%
\includegraphics[width=25cm,height=25cm,keepaspectratio, valign=t]{figures/results_final/yeast_media}
\end{figure}
