...
\subsection{Membrane scission in mammalian cells}
		\subsection{Scission is dependent on dynamin} 
%		\mbox{} \\
		...
		\subsection{Dynamin is an oligomeric GTPase}
%		\mbox{} \\ 
		...
		\subsection{Dynamin interacts with BAR proteins to cause scission}
%		\mbox{} \\
	...
	\subsection{Membrane scission in yeast} \label {yeast_scission}
		...
		\subparagraph{Yeast BAR domain proteins Rvs161/167 regulate scission timing}
		\mbox{} \\
