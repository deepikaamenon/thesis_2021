...
\begin{figure}[H]
	...
	{Reprinted by permission from Macmillan Publishers Ltd: Nature ReviewsMolecular Cell Biology (Mayor and Pagano, 2007), copyright (2007)}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{figures/intro/Fig2}
