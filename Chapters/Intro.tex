...
\hspace*{-0.5cm}
	...
	\caption[Endocytic pathways in cells]
	{ A: Model for a clathrin-cated vesicle based on cryo- electronmicroscopy. Three individual triskeleons are highlighted. \textit{ Reprinted wjth permission from Springer Nature: Nature. Molecular model for a complete clathrin lattice from electron cryomicroscopy,  Fotin et al., Copyright 2004}.
