...
\vspace{5mm}
Dynamin and BAR proteins Endophilin and Amphiphysin co-operatively recruit each other via interaction between the dynamin PRD and BAR SH3 domains41–43.  Although dynamin does not require BAR proteins to localize to clathrin-coated pits, both GTP hydrolysis and an interaction between the BAR proteins and dynamin is necessary for efficient vesicle scission42,44. 
