...
\vspace{5mm}
Dynamin and BAR proteins Endophilin and Amphiphysin interact via the dynamin PRD and BAR SH3 domains41–43. Endophilin recruitment is reduced in the absence of dynamin, although amphiphysin levels are unchanged, while deletion of amphiphysin results in increased recruitment and prolonged lifetimes of dynamin, with decreased dynamin recruitment without endophilin. These results are consistent with the a role for amphiphysin for disassembly of dynamin through GTP hydrolysis, and a role for endophilin in dynamin assembly. Although dynamin does not require BAR proteins to localize to clathrin-coated pits, both GTP hydrolysis and an interaction between the BAR proteins and dynamin is necessary for efficient vesicle scission42,45.
