...
%\vspace{5mm}
	...
	{A, B: Movement and normalized fluorescent intensity of Sla1 in WT and \textit{vps1$\Delta$} cells. Time =0 (s) for WT Sla1 centroid corresponds to scission time. Sla1 for \textit{vps1$\Delta$} is shifted in time to begin inwards movement at the same time as WT. 
