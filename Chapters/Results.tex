...
\section{Recruitment of Rvs and function of domains} 
	...
	{A: Max. intensity projections of time-lapse images of cells expressing GFP-tagged full length (FL) or BAR Rvs167 with Abp1-mCherry. Exposure rate 250ms. B: Schematic of endocytic progression in WT and BAR cells (BAR invaginations are shorter, and recruit fewer Rvs molecules: see section \ref{delsh3_movement}).
