...
Fig.2.11 A: Averaged centroid movement of Sla1-GFP in haploid cells consisting of 1 (WT: 1xh) and two copies (2xh) of Rvs genes, 1 (1xBAR) and 2 copies of BAR domain ( 2xBAR), rvs167Δcells.
B: Rvs167 movement in the cells as in Fig.2.11A, except rvs167del.
C: Maximum molecule number and standard error of mean of Rvs167 recruited to endocytic sites in the respective cells. P-values from two-sided z test,  * = p < 0.05 , ** = p<0.01, *** = p<0.001.
