...
This shows that the coat movement is sensitive to the amount of Rvs, and needs only the BAR domain interaction.
	...
	%	\centering
		...
		D: Maximum molecules recruited and SEM of Rvs167 and BAR. P-values from two-sided z test, * = p$\leq$ 0.05, ** = p$\leq$ 0.01, *** = p$\leq$ 0.001. Shadings in A, B represent 95\% confidence intervals.}
		\label{fig_scaffold}
		\end{figure}
