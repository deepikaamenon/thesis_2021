...
\begin{figure}[H]
	...
	{A: Movement of Sla1 and full-length Rvs167, and Sla1 and BAR in BAR cells. All centroid movements are aligned so that time=0 (s) corresponds to scission time. 
		B: Molecule numbers of Abp1 and Rvs167, and Abp1 and BAR in BAR cells.
		C: Molecule numbers in WT and BAR cells. Maximum and standard error of mean are shown, p-values from two-sided z test, * = p $\leq$ 0.05 , ** = p$\leq$ 0.01, *** = p $\leq$ 0.001. 
		D: Time difference between arrival of Sla1 or Abp1 and Rvs167 or BAR. Time difference measured from TIRF images of  Rvs167- or BAR-GFP/ Abp1-mCherry and Rvs167- or BAR-GFP/ Sla1-mCherry. Mean and standard error of the mean are shown. p-values of two-sided t test,  * = p$\leq$ 0.05, ** = p$\leq$ 0.01, *** = p$\leq$ 0.001. 
