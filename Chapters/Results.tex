...
Dynamics of Rvs disassembly are quite different. Fig.2.8B shows that disassembly is slowed by ~1.5 seconds in 2xh compared to 1xh cell. In the corresponding Rvs centroid movement traces (Fig.2.8C), instead of the sharp jump seen in WT, there is a delay in movement into the cytoplasm.
				...
				\caption[Overexpression of the Rvs complex in haploid cells]
					{A. Movement Sla1-GFP in haploid cells containing 1 (WT, 1xh) and 2 copies (2xh) of Rvs161, Rvs167 genes. Centroid of Sla1-GFP in 1xh is aligned so that time=0 (s) corresponds to scission time. Centroid of 2xh is shifted to move inwards at the same time. 
...
\newpage
						...
						B. Rvs167 movement in 1xd, 2xd and 4xd cells. All are aligned so that time=0 (s) corresponds to maximum fluorescent intensity.
						C.  Scaled fluorescent intensities of Rvs167-GFP in 1xd, 2xd, 4xd cells. Time=0 (s) corresponds to maximum fluorescent intensity. 
