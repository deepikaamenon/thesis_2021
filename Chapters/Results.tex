...
\newpage
						\begin{figure}[H]
						\centering
						\includegraphics[width=19cm,height=19cm,keepaspectratio]{figures/results_final/protein_friction4}
						...
						\begin{figure}[H]
	\centering
	\includegraphics[width=19cm,height=19cm,keepaspectratio]{figures/results_final/protein_frictionB}
	\caption[Abp1 ]
