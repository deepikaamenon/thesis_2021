...
This shows that shallow invaginations of the rvs167Δ can be rescued by recruiting only BAR domains of Rvs167.
	...
	%	\centering
		...
		C: Maximum molecule number and standard error of mean of Rvs167-GFP at endocytic sites in the respective cells. P-values from two-sided z test, * = p$\leq$ 0.05, ** = p$\leq$ 0.01, *** = p$\leq$ 0.001. }
		\label{fig_scaffold}
		\end{figure}
