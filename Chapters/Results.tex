...
\newpage
						...
						{A. Movement of Sla1-GFP in diploid cells consisting of 1 (2xd), 2 (WT, 2xd) and 4 copies (4xd) of Rvs161, Rvs167 genes. Sla1-GFP for 2x and 4x copies of Rvs are aligned so that Time=0 (s) corresponds to scission time. 1xd Sla1-GFP centroid  is shifted to move inwards at the same time as the other two.
