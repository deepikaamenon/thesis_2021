...
This shows that the Rvs scaffold does not serve to counter turgor pressure.  
	...
	{Movement of Sla1-GFP in WT, WT cells treated with 0.2M sorbitol, \textit{rvs167$\Delta$} and \textit{rvs167$\Delta$} cells treated with 0.2M sorbitol. WT Sla1-GFP aligned to scisstion time, other centroids moved to match inwards movement to WT Sla1-GFP}
	\end{figure}
