...
This shows that the coat movement is sensitive to the amount of Rvs, and needs only the BAR domain interaction.
	...
	%	\centering
		...
		D: Maximum molecule number and standard error of mean of Rvs167 and BAR recruited to endocytic sites. P-values from two-sided z test, * = p$\leq$ 0.05, ** = p$\leq$ 0.01, *** = p$\leq$ 0.001. }
		\label{fig_scaffold}
		\end{figure}
