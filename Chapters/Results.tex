...
\underline{Sla1 movement in synaptojanin deleted cells is unchanged}
 ...
 both \textit{inp51$\Delta$} and \textit{inp52$\Delta$} cells, Sla1-GFP patches are assembled and disassembled, as is Rvs167-GFP. Sla1 retraction rates are slightly increased to 12\% in \textit{inp52$\Delta$}, compared to 2\% in WT, and 6\% in \textit{inp51$\Delta$}
(Fig.\ref{fig_inp}B). 
\vspace{5mm}
...
\subsubsection{Rvs duplication in haploid cells}
...
%		\subparagraph{Sla1 and Rvs in gene duplicated diploids:}
		...
		\subsubsection{Rvs duplication in diploid cells}
		\label{sub_rvsdiploids}
		
			 \underline{Sla1 dynamics does not change with increased recruitment of Rvs}
			 
			 \underline{Rvs recruitment changes with Rvs gene copy number}
