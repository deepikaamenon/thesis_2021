...
This shows that the coat movement is sensitive to the amount of Rvs, and needs only the BAR domain interaction.
	...
	%	\centering
		...
		B: Movement of Rvs167 in 1xh, 2xh, BAR in 1xBAR, 2XBAR cells. Time= 0 (s) for WT Rvs167 (1xh) corresponds to scission time. Other centroids shifted to move inwards at the same time as WT.
