...
\vspace{5mm}
Averaged centroid tracking as in Picco et al., 2015, is used throughout this work to quantify the movement of endocytic proteins. Averaged centroid movement is referred to as just  “movement”. Unless indicated otherwise, “scission time” refers to the fluorescent intensity maximum of averaged Abp1 patches. The protein of interest is aligned in the endocytic timeline to "scission time" by simultaneous dual-colour imaging of this protein and Abp1, as in Picco et al., 2015.
...
\vspace{2mm}
	...
	\begin{figure}[H]
		\centering
		\hspace{-1cm}
		\includegraphics[width=15cm,height=20cm, keepaspectratio, valign=t]{figures/results_final/rvsdeletion3}
