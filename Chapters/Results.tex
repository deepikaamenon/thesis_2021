...
\begin{figure}[H]
	...
	{A: Maximum intensity projections of cells expressing GFP-tagged Inp51, Inp52, and Inp53. Exposure time 80ms.
		...
		C: Maximum intensity projection of Sla1-GFP in WT,  \textit{inp51$\Delta$},  \textit{inp52$\Delta$} cells, and max. int. projection of Rvs167-GFP in WT,  \textit{inp51$\Delta$},  \textit{inp52$\Delta$} and  \textit{inp51$\Delta$}\textit{inp52$\Delta$}   cells.
...
\vspace{5mm}
				...
				\begin{figure}[H]
	\centering
	\includegraphics[width=15cm,height=15cm,keepaspectratio]{figures/results_final/rvs_haploid2}
	\vspace*{2mm}
...
This shows that the coat movement is sensitive to the amount of Rvs, and needs only the BAR domain interaction.
	...
	%	\centering
		...
		{A: Movement of Sla1 in haploid cells consisting of 1 (1xh) and two copies (2xh) of Rvs genes, 1 (1xBAR) and 2 copies (2xBAR) of BAR domain and  \textit{rvs167$\Delta$} cells. Time=0 (s) for WT Sla1 is scission time. Other Sla1 centroids are shifted to move inwards at the same time as WT.
		B: Movement of Rvs167 in 1xh, 2xh, and BAR in 1xBAR, 2XBAR cells. Time= 0 (s) for WT Rvs167 (1xh) corresponds to scission time. Other centroids shifted to move inwards at the same time as WT.
