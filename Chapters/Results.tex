...
\newpage
						...
						{A. Movement of Sla1-GFP in diploid cells containing 1 (2xd), 2 (WT, 2xd) and 4 copies (4xd) of Rvs161, Rvs167 genes. Sla1-GFP centroids for 2xd and 4xd copies of Rvs are aligned so that Time=0 (s) corresponds to scission time. 1xd Sla1-GFP centroid is shifted to move inwards at the same time as the other two.
						B. Rvs167 movement in cells containing 1, 2, and 4 copies of Rvs genes. Each is aligned so that time=0 (s) corresponds fluorescent intensity maximum.
