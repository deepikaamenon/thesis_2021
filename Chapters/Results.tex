...
\vspace{5mm}
	...
	{A. Movement of Sla1 in haploid cells containing 1 (1xh) and 2 copies (2xh) of RVS161, RVS167 genes. Sla1 centroid in 1xh is aligned so that time=0 (s) corresponds to scission time. Centroid of 2xh Sla1 is shifted to move inwards at the same time. 
		B. C Movement and molecule numbers of Rvs167 recruited in 1xh and 2xh cells. In B and C, Rvs167 in 1xh is aligned to scission time. Rvs167 in 2xh is shifted to move inwards at the same time as 1xh. Shadings in A, B, C represent 95\% confidence intervals.
...
\includegraphics[width=21cm,height=21cm,keepaspectratio]{figures/results_final/protein_friction7}
	...
	{A. Maximum intensity projection of WT haploid and diploid cells expressing Rvs167-GFP. Scale bar =2um.   
		...
		D. Movement of Sla1 in 1xd, 2xd and 4xd cells. Sla1 centroids for 2xd, 4xd are aligned so that Time=0 (s) corresponds to scission time. 1xd Sla1-GFP centroid is shifted to move inwards at the same time as the other two. Shadings in B, C, D represent 95\% confidence intervals.
