...
Fig.2.7 A: Movement of Sla1-GFP in WT, inp51Δ and inp52Δ strains. Time=0 (s) for WT strains corresponds to scission time. Sla1 centroids for inp51Δ and inp52Δ have been shifted in time to move inwards at the same time as the WT strain. 
B: Median molecule numbers and standard error of mean of Rvs167-GFP in WT, inp51Δ and inp52Δ strains. P-values from two-sided z test,  * = p < 0.05 , ** = p<0.01, *** = p<0.001.
C: Movement of Rvs167-GFP in WT, inp51Δ and inp52Δ strains. Time=0 (s) for WT Rvs167-GFP corresponds to scission time. Rvs167-GFP for inp51del, inp52Δ strains have been shifted so that time=0 (s) corresponds to time of maximum of respective fluorescent intensity. 
