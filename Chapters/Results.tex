...
Fig.2.9 A: Averaged centroid movement of Sla1-GFP in diploid cells consisting of 1, 2, and 4 copies of the Rvs161 and Rvs167 genes. Sla1-GFP for 2x and 4x copies of Rvs are aligned so that Time=0 (s) corresponds to scission time. Sla1-GFP for 1x strain was shifted to move inwards at the same time as the other two.
