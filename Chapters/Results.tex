...
\begin{figure}
	\centering
	\includegraphics[width=17cm,height=17cm,keepaspectratio]{../../../figures/results_final/vps}
...
\end{figure}
	...
	Another hypothesis has proposed that lipid hydrolysis by yeast synaptojanin-like proteins can cause vesicle scission19. Synaptojanins phosphorylate PiP2, a lipid subtype enriched at endocytic sites. In this model, Rvs would form a scaffold on the membrane tube, protecting the underlying PiP2 and causing a boundary between BAR-protected PiP2 at the tube and hydrolyzed PiP2 at the bud tip. This lipid boundary produces a line tension at the interphase that would generate enough force to pinch off a vesicle. There are three yeast Synaptojanin-like proteins Inp51, Inp52 and Inp53. Deletion of neither Inp51 nor Inp52 affect Sla1 and Rvs167 dynamics, although the lifetime of Rvs167 is slightly increased post scission (discussed later). The amount of Rvs167 recruited to the sites is the same as in the WT (not shown). Inp53-GFP localizes to patches in the cytoplasm, likely to the trans-golgi network, as has been shown in other work.
...
\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=15cm,height=15cm,keepaspectratio]{../../../figures/results_final/inp_movement}
