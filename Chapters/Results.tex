...
%\mbox{}\\
The process of endocytosis can be tracked by following the dynamics of coat, actin, and scission module proteins. Sla1, a late-stage coat protein moves inward with the membrane as it invaginates. It thus serves as a marker for membrane invagination and is used throughout this work to track coat movement. In Fig.\ref{fig1_schematic}B, a kymograph of a Sla1-GFP patch at the plasma membrane shows that it arrives at endocytic sites, and then moves inward into the cytoplasm. Actin-binding protein Abp1, which labels the actin network, moves inward as soon as it arrives at endocytic sites. Rvs167, the scission-stage protein, has a relatively short lifetime, and jumps into the cytoplasm instead of moving gradually. 
