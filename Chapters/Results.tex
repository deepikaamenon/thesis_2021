...
%	\includegraphics[width=20cm,height=20cm,keepaspectratio]{../../../figures/results_final/sla2_del_final3}
	...
	Another hypothesis has proposed that regulated lipid hydrolysis can cause vesicle scission19. In the endocytic timeline, the lipid subtype of the membrane appears to be well regulated, and there is evidence that this could play an important role in different stages of membrane invagination. Isoforms of Phosphatidylinositols (PIs) control many cellular processes including membrane trafficking and cell signalling. Phosphatidylinositol(4,5)-biphosphate (PIP(4,5)2) is an important lipid type found at the cell surface, and are enriched and depleted from endocytic sites at the plasma membrane with assembly and disassembly of the endocytic machinery. Phosphorylation and dephophorylation by various kinases and phosphatases drives conversion of PI(4,5)P2 at the plasma membrane to PI3P, which is enriched at the endosomes: PI isofroms appear to be controlled throughout the membrane trafficking pathway. 
	
	\vspace{5mm}
	Synaptojananins (Sjn)  are PI(4,5)P2 phosphatases that convert PI(4,5)P2 to PI(4)P by removing the phosphate at the 5’ position of the PI inositol ring. Synaptojanins localize to endocytic sites, and in mammalian cells, their disruption results in accumulation of coated vesicles, suggesting a role for lipid hydrolysis in releasing coat proteins from nascent vesicles. Further, they have proline-rich domains that are the canonical interaction partners of SH3 domains: they are known to interact with actin binding proteins and BAR domain proteins, potentiating also a role in membrane invagination and scission. 

	\vspace{5mm}
	In yeast, there are three Synaptojanin-like proteins: Inp51, Inp52 and Inp53, that regulate PI metabolism. Double deletion of Inp51 and Inp52 has been shown to increase the lifetime of endocytic proteins and reduce endocytosis. Deletion of Inp52 along with Rvs167 increases scission failure rate, indicating a possible role in membrane scission. 
	
		
	\begin{figure}
	\centering
		\includegraphics[width=15cm,height=15cm,keepaspectratio]{../../../figures/results_final/inp}
		\caption{Yeast synaptojanins \label{fig4_inp}}
	\end{figure}

	\vspace{5mm}
	In a model proposed by Liu et al, Synpatojanins and BAR proteins interact to regulate lipid hydrolysis, which in turn drives me	mbrane scission. Here, the Rvs scaffold on the membrane tube protects the underlying PIP2 from hydrolysis. Synaptojanin arrives at sites, and hydrolyses unprotected PIP2. This generates a boundary between BAR-protected PIP2 at the tube and PIP at the bud tip. The lipid boundary produces a line tension at the interphase that would generate enough force to pinch off a vesicle. 

	\vspace{5mm}
	I tested this model by investigating the effect of synaptojanin on coat and scission proteins. First, of the three Synaptojanins, only Inp52-GFP localizes to cortical patches. Dual color imaging and time alignment with Abp1 as described in Picco et al., shows that Inp52 localizes to endocytic sites at the late stage of scission. The centroid of Inp52-GFP can be localized to the tip of the invaginated tube, consistent with the Liu theory of membrane scission: Inp52 localizes spatially and temporally at sites to effect membrane scission. Inp51-GFP exhibits a diffuse cytoplasmic signal, while Inp52 localizes to patches within the cytoplasm, likely to the trans-golgi network, as has been noted in other work. Deletion of Inp52 does not affect Sla1 and Rvs167 dynamics however, although both Sla1 and Rvs167 centroids persists post scission, instead of disassembling immediately like in the WT. This is consistent with a role for Inp52 in vesicle uncoating, rather than membrane scission.
