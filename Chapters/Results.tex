...
\vspace{2mm}
	...
	\begin{figure}[H]
		...
		{Movement of Sla1 in WT and  \textit{rvs167$\Delta$} cells. WT Sla1 is aligned so that time=0 (s) corresponds to scission time. Sla1 centroid  in \textit{rvs167$\Delta$} cells is shifted in time so that it moves inwards at the same time as WT Sla1. Red line indicates approximate start of deviation of \textit{rvs167$\Delta$} from WT. 
			\label{fig2_rvsdelta}
		}
	\end{figure}
...
\underline{Abp1 amount do not change with increasing Rvs recruitment}
...
\begin{table}[H]
	...
	{ Cytoplasmic intensities measured in different strains.
		\label{table2}}
