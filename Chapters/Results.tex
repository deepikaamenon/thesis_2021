...
\subsubsection{Hypothesis2: Rvs is a scaffold against turgor pressure} 
...
\begin{table}[H]
	...
	{ Cytoplasmic intensities of Rvs167-GFP, except for BAR, in which BAR-GFP cytoplasmic intensity is measured. * = WT Rvs167-GFP and BAR-GFP cytoplasmic intensities measured on the same day. All the diploid strains were imaged on the same day.
		\label{table2}}
